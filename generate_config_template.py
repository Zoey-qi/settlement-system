...
def main():
    ...
    data = [
        ...
        ('对上结算', '人力资源部', '农民工工资发放表、考勤表', 30, '证明无欠薪'),
        ('对上结算', '综合办公室', '分包人员宿舍租赁、水电、食堂伙食费扣款单', 30, '总承包管理费分摊'),
        ...
        ('对下结算', '人力资源部', '工资代发清单（即分包用菲籍工人）、考勤抽查记录、自用人工费', 28, '工资发放核查，防欠薪纠纷'),
        ('对下结算', '综合办公室', '水电、住宿、食堂等后勤扣款', 28, '现场经费扣款'),
