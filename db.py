...
def seed_default_data(db):
    ...
    # 部门（2026-08-13：人力资源部已并入综合办公室，部门行不再 seed）
    departments = [
        ('生产调度部', '', 1), ('工程质量技术部', '', 2),
        ('安全环保部', '', 3), ('设备物资部', '', 4),
        ('综合办公室', '', 6),
    ...
    upstream = [
        ...
        # 2026-08-13：原 HR 任务"农民工工资发放表/考勤表"由综合办公室承接（与后勤一并管理）
        ('综合办公室', up, '农民工工资发放表、考勤表、分包人员宿舍租赁、水电、食堂伙食费扣款单（联系综合工区张勇或其他联营体指定人员）', 30, '证明无欠薪 + 总承包管理费分摊'),
    ...
    downstream = [
        ...
        # 2026-08-13：原 HR 对下"工资代发/考勤"任务并入综合办公室
        ('综合办公室', down, '工资代发清单（即分包用菲籍工人）、考勤抽查记录、自用人工费、水电、住宿、食堂等后勤扣款', 28, '工资发放核查 + 现场经费扣款（防欠薪纠纷）'),
